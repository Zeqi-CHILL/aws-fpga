...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "./.Xil/Vivado-2289-ip-172-31-18-31.ec2.internal/realtime/tmp"
    ...
    set rt::SDCFileList ./.Xil/Vivado-2289-ip-172-31-18-31.ec2.internal/realtime/cl_fifo_synth.xdc
    rt::sdcChecksum
    set rt::top cl_fifo
...
# MODE: out_of_context
    ...
    rt::set_parameter enableSplitFlowPath "./.Xil/Vivado-2289-ip-172-31-18-31.ec2.internal/"
