...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "./.Xil/Vivado-8549-ip-172-31-22-34.ec2.internal/realtime/tmp"
    ...
    set rt::SDCFileList ./.Xil/Vivado-8549-ip-172-31-22-34.ec2.internal/realtime/cl_fifo_synth.xdc
    rt::sdcChecksum
    set rt::top cl_fifo
...
# MODE: out_of_context
    ...
    rt::set_parameter enableSplitFlowPath "./.Xil/Vivado-8549-ip-172-31-22-34.ec2.internal/"
